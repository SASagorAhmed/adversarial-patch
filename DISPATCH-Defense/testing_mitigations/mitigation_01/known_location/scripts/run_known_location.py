#!/usr/bin/env python
"""Known-Location LDM branch — testing_mitigations/mitigation_01/known_location.

Receives saved true patch coordinates. Does NOT use L2/KMeans localization.
Writes ONLY under this Known Location branch.
"""
...
def main() -> int:
    ...
    kex_ctrl = "YES" if ctrl and yn(ctrl[0]["known_exact_control_preserved"]) else "NO"
    k4_ctrl = "YES" if ctrl and yn(ctrl[0]["known_expand4_control_preserved"]) else "NO"
    outside_ok = all(
    ...
    txt = f"""TESTING MITIGATION 01 — KNOWN LOCATION LDM
===========================================
