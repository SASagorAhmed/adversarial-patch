#!/usr/bin/env python
"""Helpers for testing_mitigations/mitigation_01 branches (diagnostic only)."""
...
TESTING_ROOT = DISPATCH_ROOT / "testing_mitigations" / "mitigation_01"
...
SELECTION_REASONS = {
    "000000127263": "Fixed: previously recovered DISPATCH attack-success car (patch_size=20).",
    "000000393093": "Fixed: previously recovered DISPATCH attack-success car (patch_size=14).",
    "000000026926": "Deterministic failed attack-success; smallest patch_size>=20 (small/medium).",
    "000000407083": "Deterministic failed attack-success; largest remaining patch_size.",
    "000000331604": "Deterministic preserved person control; earliest matching image_id.",
}
...
def print_preflight() -> None:
    ...
    print("MITIGATION 01 FRESH RECREATE PREFLIGHT")
    print("===============================================")
    print()
    print("Output:")
    ...
    print("YES")
    print()
    print("Testing mitigation_01 safe to create:")
    print("YES")
    print()
    ...
    print("NO")
    print()
    print("mitigation_01 currently empty/safe:")
    print("YES  (testing folder; original 30-image run left frozen)")
    print()
    print("mitigation_02 being created:")
    print("NO")
    print()
    print("testing_mitigations being recreated:")
    print("NO  (only testing_mitigations/mitigation_01)")
    print()
    ...
    print("YES")
    print()
    print("5 selected images resolved:")
    print("YES")
    print()
    print("Same 5 images assigned to both:")
    print("YES")
    print()
